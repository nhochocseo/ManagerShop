        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsProjectAdmin = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<long>(nullable: false),
                    ManagerShopId = table.Column<long>(nullable: false),
                    TaskId = table.Column<long>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ManagerShopItems", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ManagerShopItems_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ManagerShopItems_Tasks_TaskId",
                        column: x => x.TaskId,
                        principalTable: "Tasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ManagerShopItems_ProjectId",
                table: "ManagerShopItems",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ManagerShopItems_TaskId",
                table: "ManagerShopItems",
                column: "TaskId");
